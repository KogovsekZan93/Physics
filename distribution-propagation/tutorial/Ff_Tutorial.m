...
% vector Vec_Ff_Tutorial, which is the output vector of the 
% f_Tutorial function with the 'Vec_Input' vectors as its input, 
% which is appended by the 'Vec_Figure' vector and the 
% 'Validity' number. 
