...
% where the 'Avg_Std_f'(j, 1) value is the average value of the 
% j-th output variable of the f function and the 'Avg_Std_f'(j, 2) 
% value is the value of the standard deviation of the j-th output 
% variable of the f function. 
...
% value of the standard deviation of the j-th variable of the f 
% function. The values of the 'Avg_Std_f' matrix are based on 
% 'N_Rnd' valid outputs of the f function, the validity of the 
% outputs being based on the value of the final output variable of 
% the F function. The input values for each valid output of the f 
