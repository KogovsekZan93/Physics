...
%% Tool for finding the average values and the standard deviations of the 
%% output variables
% 
% Author: Žan Kogovšek
% Date: 9.14.2023
...
% function returns the matrix 'Avg_ Std _f', where the 'Avg_Std_f'(j, 1) 
% value is the average value of the j-th output variable of the f function 
% and the 'Avg_Std_f'(j, 2) value is the value of the standard deviation 
% of the j-th output variable of the f function. 
...
% The values of the 'Avg_Std_f' matrix are based on 'N_Rnd' valid outputs 
% of the f function, where the input values are randomly generated based 
% on the distribution of the input variables. 
% 
%% Variables
% 
% This function has the form of Avg_Std_f = FindOutputVariableAvgStd...
% (InputVariablesDistributionInfo, handle_F, N_Rnd)
% 
...
%       calculation of the average and the standard deviation of the 
%       output variables of the f function if they are valid. If not, a 
%       new vector is randomly generated in place of the invalid one. 
% 
% 'N_Rnd' is the number of valid output vectors vec_f of the f function to 
% be randomly generated and used to calculate the average and the standard 
% deviation of each variable of the output vector of the f function. It 
% must be a natural number. 
% 
% 'Avg_Std_f' is a matrix of two columns, where the 'Avg_Std_f'(j, 1) 
% value is the average value of the j-th output variable of the f function 
% and the 'Avg_Std_f'(j, 2) value is the value of the standard deviation 
% of the j-th variable of the f function. The values of the 'Avg_Std_f' 
% matrix are based on 'N_Rnd' valid outputs of the f function, the 
% validity of the outputs being based on the value of the final output 
% variable of the F function. The input values for each valid output of 
% the f function are randomly generated based on the distribution of the 
% input variables, specified by the 'InputVariablesDistributionInfo' cell 
% array. 
...
Avg_Std_f = ...
    [mean(OutputVariablesMatrix, 2), std(OutputVariablesMatrix, 0, 2)];
