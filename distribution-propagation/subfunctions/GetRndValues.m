...
% X_i, each X_i  variable being either a number or a column 
...
%         numbers. 
%            In this case, the X_i variable of the f function is a 
...
%         numbers. 
%            In this case, the X_i variable of the f function is a 
%            column vector. The values of the X_i variable will be the 
...
%            values v(k) of each vector v being independently 
...
%            In this case, the X_i variable of the f function is a 
%            column vector. The values of the X_i variable will be 
...
% is actually created by generating each horizontal row of it 
