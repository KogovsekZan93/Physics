...
%         (vec_F("length_f" + 1 : 2 * "length_f")), the value of each 
%         variable vec_F(m + "length_f") is the m-th value of the 
%         "figureVector", which can be used as an input parameter 
%         of the DrawOutputVariableDistribution function. 
...
%         vec_f vector are valid. The vec_f vector will only used to 
...
% from the "vec_F" vectors which are valid (i.e. 
% "vec_F"(end) == 1), the vec_f vectors are extracted (i.e. 
% "vec_F"(1 : "length_f") and used to replace the yet 
% nonreplaced columns of zeros of the "OutputVariablesMatrix" 
% matrix. 
