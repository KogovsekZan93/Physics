% The test for the simple-linear-regression function package is 
...
close(Figure);
clear Slope Intercept CovarMat_SlopeIntercept ...
    CovarMat_yData Figure SlopeStandard InterceptStandard ...
    CovarMat_SlopeInterceptStandard
...
[Slope, Intercept, ...
    Variance_yData, CovarMat_SlopeIntercept] = ...
    FindSimpleLinearRegressionCoefficients...
    (xData, yData);
CovarMat_SlopeInterceptStandard = ...
