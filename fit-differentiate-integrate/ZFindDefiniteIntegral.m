...
% 'DefiniteIntegral' of the definite integral 
% f('Limits'(2)) - f('Limits'(1)), where 'Limits' is the input vector of a 
% pair of values of the X variable. 
...
%        it from min('Limits') to max('Limits'), which is colored based on 
%        the order of the pair of values of the 'Limits' vector along with 
%        the data points represented by the pairs 
%        ('xData'(i), 'yData'(i)). 
% 
%% Variables
% 
...
% the function ZFindDefiniteIntegral is to estimate the value of 
% f('Limits'(2)) - f('Limits'(1)). The 'Limits' vector must be a column 
...
%     ''Type'' parameter determines the set of the additional required or 
...
% 
% 'DefiniteIntegral' is the estimated value of the integral of the df/dX 
