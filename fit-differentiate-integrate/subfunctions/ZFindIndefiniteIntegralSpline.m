function yIndefiniteIntegralSpline = ZFindIndefiniteIntegralSpline...
...
% 'yIndefiniteIntegralSpline' of the estimated values of 
% f('xIntegralSpline') - f('xIntegralSpline'(1)), where 'xIntegralSpline' 
...
% 'xIntegralSpline'(1) to 'xIntegralSpline'(end) along with the data 
% points. 
% 
%% Variables
% 
% This function has the form of yIndefiniteIntegralSpline = ...
% ZFindIndefiniteIntegralSpline(xData, yData, xIntegralSpline, varargin)
% 
...
% f('xIntegralSpline') - f('xIntegralSpline'(1)) is to be estimated. The 
% 'xIntegralSpline' vector must be a column vector of real numbers. The 
% values of the 'xIntegralSpline' vector must be in ascending order. 
% 
...
% estimated df/dX function curve is filled from min('xIntegralSpline'(1)) 
% to max('xIntegralSpline'(2)). 
...
% estimated values of f('xIntegralSpline') - f('xIntegralSpline'(1)). 
...
[yIndefiniteIntegralSpline, ppFitSpline] = ZFindIntegralSplineBasic...
...
DecideIfDrawZ(DrawZIntegralSplineHandle, DrawZIntegralSplineInput, ...
    varargin{:});
