...
%% Polynomial regression-based curve fitting tool with visualization
% 
% Author: Žan Kogovšek
% Date: 9.11.2022
...
% 'yFitPolyFit' of the estimated values of f('xFitPolyFit'), where 
% 'xFitPolyFit' is the input vector of values of the X variable. The 
% estimation is based on the polynomial regression interpolation of the 
...
% ZFindFitPolyFit(xData, yData, xFitPolyFit, PolyDegree, varargin)
% 
...
% 
% 'xFitPolyFit' is the vector of the values of the independent variable X 
% at which the value of the f function is to be estimated. The 
% 'xFitPolyFit' vector must be a column vector of real numbers. 
% 
...
% of the figure window on which the data points along with the estimation 
% of the f function is to be plotted. 
...
DrawZFitPolyFitInput = {xData, yData, min(xData(1), xFitPolyFit(1)), ...
