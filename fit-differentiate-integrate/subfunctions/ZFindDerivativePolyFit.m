...
%% Numerical polynomial regression-based differentiation tool with 
%% visualization
% 
% Author: Žan Kogovšek
% Date: 9.11.2022
% Last changed: 29.5.2024
% 
%% Description
% 
...
% polynomial which is the 'OrdDeriv'-th derivative of the 'PolyDegree'-th 
% degree regression polynomial of the data points represented by the pairs 
% ('xData'(i), 'yData'(i)). 
% 'pDerivativePolyFit' is a column vector of the form of 
% [a_('PolyDegree' - 'OrdDeriv'); a_('PolyDegree' - 'OrdDeriv' - 1); ...; 
% a_1; a_0]. The differentiated regression polynomial can be evaluated by 
...
[yDerivativePolyFit, pDerivativePolyFit, pFitPolyFit] = ...
    ...
    (xData, yData, xDerivativePolyFit, PolyDegree, 'OrdDeriv', OrdDeriv);
