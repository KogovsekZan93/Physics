...
%     interpolation polynomial which represents the f function is 
...
%     estimated f function curve is to be plotted. 
...
DrawZFitAInput = {xData, yData, min(xDerivativeA(1), xData(1)), ...
    max(xDerivativeA(end), xData(end)), Ipoints, Smatrix};
