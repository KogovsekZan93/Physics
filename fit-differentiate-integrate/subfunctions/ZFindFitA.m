...
%% Piecewise interpolation polynomial-based curve fitting tool with 
%% visualization
% 
% Author: Žan Kogovšek
% Date: 11.12.2022
...
% arbitrary function Y = f(X), this function returns the vector 'yFitA' of 
% the estimated values of f('xFitA'), where 'xFitA' is the input vector of 
% values of the X variable. The estimation is based on a piecewise 
...
%% Variables
% 
% This function has the form of [yFitA, varargout] = ZFindFitA...
...
% which the value of the f function is to be estimated. The 'xFitA' vector 
% must be a column vector of real numbers. The values of the 'xFitA' 
% vector must be in ascending order. 
% 
...
%     is composed. It must be a nonnegative integer. The default value is 
%     0. 
...
% 
% 'yFitA' is the column vector of the estimated values of f('xFitA'). 
% 
...
[FigureParameter, vararginBasic] = SeparateOptionalParameter...
    (varargin, 'Figure');
