...
%% Numerical spline-based definite integration tool with visualization
% 
% Author: Žan Kogovšek
% Date: 8.23.2022
...
% 'DefiniteIntegralSpline' of the definite integral 
% f('Limits'(2)) - f('Limits'(1)), where 'Limits' is the input vector of a 
% pair of values of the X variable. The estimation is based on the spline 
...
% 
% 'DefiniteIntegralSpline' is the estimated value of the integral of the 
...
% 'yIntegralSpline'(2) value by either 1 or -1 based on the order of the 
