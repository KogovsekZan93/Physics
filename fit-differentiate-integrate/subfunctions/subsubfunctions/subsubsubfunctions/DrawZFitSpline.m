...
% the pairs ('xData'(i), 'yData'(i)), and the natural number 'Figure', 
...
% create a convincing illusion of the plotted fSpline function 
% curve being smooth (as the actual fSpline function is, in fact, a 
% smooth function). 
N = power(10, 4);
