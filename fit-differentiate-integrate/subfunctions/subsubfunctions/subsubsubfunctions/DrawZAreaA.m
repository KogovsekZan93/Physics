...
% curve of the data points represented by the pairs 
% ('xData'(i), 'yData'(i)) from the 'xAreaAMin' value to the 
% 'xAreaAMax' value. The three real numbers must be values of 
% the [0, 1] interval. 
% 
...
% illusion of the plotted fA function curve being smooth over the 
