function DrawZAreaA...
    (xData, yData, xAreaAMin, xAreaAMax, ColorFace, Ipoints, Smatrix)
%% Tool for plotting the the area under the piecewise interpolation 
...
% ('xData'(i), 'yData'(i)), the values of the X variable the 'xAreaAMin' 
% value and the 'xAreaAMax' value, and the vector 'ColorFace', this 
% function plots the area under the piecewise interpolation polynomial 
% curve from 'xAreaAMin' to 'xAreaAMax', the color of the area being 
% defined by the RGB triplet of numbers of the 'ColorFace' vector. 
% 
%% Variables
% 
% This function has the form of DrawZAreaA...
% (xData, yData, xAreaAMin, xAreaAMax, ColorFace, Ipoints, Smatrix)
% 
...
% 
% The 'xAreaAMin' parameter and the 'xAreaAMax' parameter are two values 
% of the X variable and are the lower and the upper boundary, 
...
% by the pairs ('xData'(i), 'yData'(i)). The 'xAreaAMax' value must be 
...
% points represented by the pairs ('xData'(i), 'yData'(i)) from the 
% 'xAreaAMin' value to the 'xAreaAMax' value. The three real numbers must 
% be values of the [0, 1] interval. 
% 
...
% 'Ipoints'(i + 1) are the boundaries of i-th interpolation polynomial. 
% It must be a sorted column vector of numbers. 
% 
...
% points for the area under the piecewise interpolation polynomial curve 
% plot. With this setting, the number of points is typically sufficient to 
% create a convincing illusion of the plotted fA function curve being 
% smooth over the intervals over which the fA function is, in fact, 
% smooth. 
N = power(10, 4);

XFitA = (linspace(xAreaAMin, xAreaAMax, N))';
