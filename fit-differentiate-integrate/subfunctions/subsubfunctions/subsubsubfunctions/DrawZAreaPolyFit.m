...
% fPolyFit function from the 'xAreaPolyFitMin' value to the 
...
% plotted fPolyFit function curve being smooth (as the actual 
% fPolyFit function is, in fact, a smooth function). 
N = power(10, 4);
