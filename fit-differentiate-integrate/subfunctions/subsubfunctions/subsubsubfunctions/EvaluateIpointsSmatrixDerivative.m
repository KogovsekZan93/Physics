...
% "Smatrix" matrix. Each polynomial p_i of which the fA function 
...
% "xDerivativeA"(1) is contained is found. This way, uselessly 
% calculating the coefficients of the derivatives of the 
