...
%% Tool for obtaining the coefficients of the interpolation 
...
% variable Y of an arbitrary function Y = f(X) ('yData' = f('xData')), 
% this function returns the vector 'p' of the coefficients of the 
% polynomial which is the interpolation polynomial of the data 
% points represented by the pairs ('xData'(i), 'yData'(i)). 
% 
%% Variables
% 
% This function has the form of p = ...
...
% 
% 'p' is the vector of coefficients of the interpolation polynomial 
% of the data points represented by the pairs 
% ('xData'(i), 'yData'(i)). The 'p' vector is a column vector of the 
% form of 
% [a_(length('xData') - 1); a_(length('xData') - 2); ...; a_1; a_0]. 
% The polynomial can be evaluated by the MATLAB polyval 
% function. 
