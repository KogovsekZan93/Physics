...
%% Description
% 
% Given the column vector 'xData' of real numbers and the 
% natural number 'nA', this function creates groups of 'nA' 
% indices in rows of the 'Smatrix' matrix and the vector 'Ipoints' 
% of values which are used by the ZFind...A functions as the 
% boundaries between interpolation polynomials defined using 
% groups of the 'xData' vector values indexed by the individual 
% rows of the 'Smatrix'. The values of the 'Ipoints' vector are 
% based on the value of the input 'Mode' parameter. 
% 
%% Variables
% 
...
% 
% 'xData' is the vectors of the values of the independent variable 
% X. It must be a vector of real numbers in ascending order. 
% 
...
% 
% 'Ipoints' is the column vector of values of the X variable. Each 
...
% polynomial used by the the ZFind...A functions. The i-th 
% interpolation polynomial is based on the data points, the 
% independent variable of which is 'xData'('Smatrix'(i, :)), i.e. they 
% are the values of the 'xData' indexed by the i-th row of the 
% 'Smatrix' matrix. 
...
%    -If 'Mode' = 1, the values of the 'Ipoints' vector are the same 
%     as with 'Mode' = 0 with two corrections for 'Ipoints'(i) values 
%     other than the 'Ipoints'(1) value and the 'Ipoints'(end) value 
...
% 
% Smatrix is the matrix of 'nA' columns and 
% 'xDataLength' - 'nA' + 1 rows. Each i-th row contains 'nA' 
...
% determined for the value of the 'Mode' parameter 'Mode' = 0. 
...
% appropriately if 'Mode' = 1 or if 'Mode' = 2. If 'nA' = 1, the 
% 'Ipoints' vector is the same regardless of the value of the 
% 'Mode' parameter. 
if nA > 1
    if Mode == 1
    % Each of the following two four loops deals with each of the 
    % two corrections of the 'Ipoints' vector described in the 
    % 'Ipoints' vector output parameter description for 'Mode' = 1. 
