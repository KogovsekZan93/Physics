...
%% Tool for plotting the data points and the piecewise interpolation 
%% polynomial curve
% 
% Author: Žan Kogovšek
% Date: 4.22.2023
...
% ('xData'(i), 'yData'(i)), and the natural number 'Figure', this function 
% plots the data points and the piecewise interpolation polynomial curve 
% of the data points from the input value of the X variable 'xFitAMin' to 
% the input value of the X variable 'xFitAMax'. 
% 
%% Variables
% 
...
% 
% The 'xFitAMin' parameter and the 'xFitAMax' parameter are two values of 
% the X variable and are the lower and the upper boundary, respectively, 
% of the interval over which the piecewise interpolation polynomial of the 
% data points represented by the pairs ('xData'(i), 'yData'(i)) is to be 
% plotted. The 'xFitAMax' value must be greater than the 'xFitAMin' value. 
% 
...
parse(pars, Figure, xData, yData, xFitAMin, xFitAMax, Ipoints, Smatrix);

% The parameter 'N' is set to be 'N' = 10 000 and represents the number of 
% points for the piecewise interpolation polynomial curve plot. With this 
% setting, the number of points is typically sufficient to create a 
% convincing illusion of the plotted fA function curve being smooth over 
% the intervals over which the fA function is, in fact, smooth. 
N = power(10, 4);
