...
% figure window on which the data points, the piecewise 
% interpolation polynomial curve, and the area under the curve 
...
% The 'xFitAMax' value must be greater than the 'xFitAMin' value. 
% 
...
% plotted fA function curve being smooth over the intervals over 
% which the fA function is, in fact, smooth. 
N = power(10, 4);
