...
%% Tool for plotting the data points and the regression polynomial curve
% 
% Author: Žan Kogovšek
% Date: 4.22.2023
...
% arbitrary function Y = f(X), the vector 'pFitPolyFit' of the 
...
% number 'Figure', this function plots the data points and the regression 
% polynomial curve of the data points from the input value of the X 
% variable 'xFitPolyFitMin' to the input value of the X variable 
% 'xFitPolyFitMax'. 
% 
%% Variables
% 
% This function has the form of DrawZFitPolyFit...
% (Figure, xData, yData, xFitPolyFitMin, xFitPolyFitMax, pFitPolyFit)
% 
% 'Figure' is the parameter the value of which is the index of the figure 
% window  on which the data points and the regression polynomial curve 
% described in the Description section is to be plotted. The value of the 
...
% 
% The 'xFitPolyFitMin' parameter and the 'xFitPolyFitMax' parameter are 
% two values of the X variable and are the lower and the upper boundary, 
% respectively, of the interval over which the regression polynomial of 
% the data points represented by the pairs ('xData'(i), 'yData'(i)) is to 
% be plotted. The 'xFitPolyFitMax' value must be greater than the 
...
% points for the regression polynomial curve plot. With this setting, the 
% number of points is typically sufficient to create a convincing illusion 
% of the fPolyFit function curve being smooth (as the actual fPolyFit 
    % function is, in fact, a smooth function). 
N = power(10, 4);
