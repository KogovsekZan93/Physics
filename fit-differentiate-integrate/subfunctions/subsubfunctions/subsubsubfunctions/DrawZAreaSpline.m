...
%% Tool for plotting the area under the interpolating 
%% spline curve over an interval
% 
% Author: Žan Kogovšek
% Date: 4.27.2023
...
%% Description
% 
% Given the input piecewise polynomial structure "ppFitSpline" 
% of the interpolating cubic spline polynomial fSpline of the 
% functon f (Y = f(X)), the values of the X variable the 
% "xAreaSplineMin" value and the "xAreaSplineMax" value, and 
% the vector "ColorFace", this function plots the area under the 
% spline curve from "xAreaSplineMin" to "xAreaSplineMax", the 
...
% (xAreaSplineMin, xAreaSplineMax, ColorFace, ppFitSpline)
% 
% The "xAreaSplineMin" parameter and the "xAreaSplineMax" 
...
% using this function under the interpolating spline curve of the 
% fSpline function. The "xAreaSplineMax" value must be greater 
% than the "xAreaSplineMin" value. 
% 
...
% fSpline function from the value "xAreaSplineMin" to the 
% "xAreaSplineMax" value. The three real numbers must be 
% values of the [0, 1] interval. 
% 
% "ppFitSpline" is the piecewise polynomial structure of the 
% interpolating cubic spline polynomial fSpline. 
...
% the number of points for the area under the cubic spline curve 
% plot. With this setting, the number of points is typically 
% sufficient to create a convincing illusion of the plotted curve of 
% the function fSpline being smooth (as the actual fSpline 
