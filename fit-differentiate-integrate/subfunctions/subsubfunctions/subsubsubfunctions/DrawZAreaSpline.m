...
% fSpline function from the 'xAreaSplineMin' value to the 
...
% sufficient to create a convincing illusion of the plotted fSpline 
% function curve being smooth (as the actual fSpline function is, 
% in fact, a smooth function). 
N = power(10, 4);
