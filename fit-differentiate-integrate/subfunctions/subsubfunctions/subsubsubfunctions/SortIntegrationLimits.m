...
% 'Limits' (2) = 'LimitsSorted'(1). 'ColorFace' is the parameter 
% that determines the color of the area under the curve plotted 
% by the DrawZIntegral... functions depending on the 
% 'LimitOrder' parameter. 
% 
%% Variables
% 
