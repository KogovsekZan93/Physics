...
% pairs ('xData'(i), 'yData'(i)) and is defined by the input variables 
% the 'Ipoints' vector and the 'Smatrix' matrix. Each polynomial 
% p_i of which the fA function consists is the interpolation 
% polynomial of the points 
...
% ('xData'(k), 'yData'(k)) which are to be used to construct the i-th 
...
% 'xFitA'(1) is contained is found. This way, useless calculation 
% of the the coefficients of the interpolation polynomials 
...
% to 'Ipoints'('j'), firstly the coefficients vector 'p' of the 
...
% the right boundary of the relevant interval (i.e. 'Ipoints'('j')), the 
% 'yFitA' vector is evaluated for the values of the 'xFitA' vector 
