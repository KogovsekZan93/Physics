...
%% Tool for evaluating a piecewise interpolation polynomial
% 
% Author: Žan Kogovšek
% Date: 2.27.2023
...
% arbitrary function Y = f(X), this function returns the vector 'yFitA', 
% which is the vector of values fA('xFitA') where fA is the input 
% 'Ipoints' vector- and the input 'Smatrix' matrix-defined piecewise 
% interpolation polynomial of the data points represented by the pairs 
% ('xData'(i), 'yData'(i)), and 'xFitA' is the input vector of values of 
% the X variable. 
% 
%% Variables
% 
% This function has the form of yFitA = EvaluateIpointsSmatrixFit...
% (xData, yData, xFitA, Ipoints, Smatrix)
% 
...
% 
% 'xFitA' is the vector of the values of the independent variable X at 
% which the value of the piecewise interpolation polynomial fA is to be 
% calculated. The fA function is a piecewise interpolation polynomial of 
% the data points represented by the pairs ('xData'(i), 'yData'(i)) and is 
% defined by the input variables the 'Ipoints' vector and the 'Smatrix' 
% matrix. Each polynomial p_i of which the fA function consists is the 
...
% The 'xFitA' vector must be a column vector of real numbers. The values 
...
% are to be used to construct the i-th interpolation polynomial p_i of the 
% piecewise interpolation polynomial fA. It must be a matrix of natural 
% numbers the height of which is length('Ipoints') - 1. 
% 
% 'yFitA' is the column vector of the calculated values of fA('xFitA'). 
...
% 'Ipoints'('j' - 1) to 'Ipoints'('j') in which the value 'xFitA'(1) is 
% contained is found. This way, useless calculation of the the 
% coefficients of the interpolation polynomials p_J for J < 'j' is 
% avoided. 
j = 2;
...
% 'Ipoints'('j'), firstly the coefficients vector 'p' of the interpolation 
...
% Then, whenever in the for loop the value 'xFitA'('b') exceeds the right 
% boundary of the relevant interval (i.e. 'Ipoints'('j')), the 'yFitA' 
% vector is evaluated for the values of the 'xFitA' vector within the 
% relevant interval. 
% Afterwards, the next interval in which the values of the 'xFitA' vector 
% are contained is found and the process is repeated until the last 
% interval in which the values of the 'xFitA' vector is contained is found 
% after which the last values of the 'yFitA' vector are calculated outside 
% of the for loop. 
