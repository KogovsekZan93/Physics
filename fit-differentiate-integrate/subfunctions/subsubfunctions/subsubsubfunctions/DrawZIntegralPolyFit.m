...
% figure window on which the data points, the regression 
...
% from the value 'xIntegralPolyFitMin' to the 'xIntegralPolyFitMax' 
% value. The three real numbers must be values of the [0, 1] 
% interval. 
% 
