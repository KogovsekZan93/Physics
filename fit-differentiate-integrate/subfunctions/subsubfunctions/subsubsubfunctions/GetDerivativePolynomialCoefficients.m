...
%% Tool for obtaining the coefficients of the polynomial which is the 
%% derivative of the interpolation polynomial of the input data
% 
% Author: Žan Kogovšek
% Date: 2.5.2023
...
% returns the vector 'pDerivativeA' of the coefficients of the polynomial 
...
% 
% 'OrdDeriv' is the parameter the value of which is the derivative order. 
% It must be a natural number. 
% 
% 'pDerivativeA' is the vector of coefficients of the polynomial which is 
% the 'OrdDeriv'-th order derivative of the interpolation polynomial of 
% the data points represented by the pairs ('xData'(i), 'yData'(i)). The 
% 'pDerivativeA' vector is a column vector of the form of 
% [a_(length('xData') - 'OrdDeriv' - 1); 
% a_(length('xData') - 'OrdDeriv' - 2); ...; a_1; a_0]. The polynomial can 
% be evaluated by the MATLAB polyval function. 
