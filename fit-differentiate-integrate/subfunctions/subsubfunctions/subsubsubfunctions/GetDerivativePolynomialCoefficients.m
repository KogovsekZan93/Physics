...
% this function returns the vector 'pDerivativeA' of the 
% coefficients of the polynomial which is the 'OrdDeriv'-th order 
% derivative of the interpolation polynomial of the data points 
...
% 
% 'OrdDeriv' is the parameter the value of which is the derivative 
% order. It must be a natural number. 
% 
