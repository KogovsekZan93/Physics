...
% is to be estimated. The 'xDerivativeA' vector must be a column 
% vector of real numbers. The values of the 'xDerivativeA' vector 
...
%     function is to be composed. It must be a nonnegative 
