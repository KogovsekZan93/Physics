function [yIntegralPolyFit, varargout] = ZFindIntegralPolyFitBasic...
    (xData, yData, xIntegralPolyFit, PolyDegree)
%% Numerical polynomial regression-based indefinite integration tool
% 
% Author: Žan Kogovšek
% Date: 12.30.2022
...
% 'yIntegralPolyFit' of the estimated values of 
...
% ZFindIntegralPolyFitBasic(xData, yData, xIntegralPolyFit, PolyDegree)
% 
...
% f('xIntegralPolyFit') - f('xIntegralPolyFit'(1)) is to be estimated. The 
% 'xIntegralPolyFit' vector must be a column vector of real numbers. The 
% values of the 'xIntegralPolyFit' vector must be in ascending order. 
% 
...
% nonnegative integer. 
% 
% 'yIntegralPolyFit' is the column vector of the estimated values of 
% f('xIntegralPolyFit') - f('xIntegralPolyFit'(1)). 
% 
% 'varargout' represents the optional output parameter 'pFitPolyFit', 
% which is the vector of coefficients of the 'PolyDegree'-th degree 
% regression polynomial of the data points represented by the pairs 
% ('xData'(i), 'yData'(i)). 
% 'pFitPolyFit' is a column vector of the form of 
% [a_'PolyDegree'; a_('PolyDegree' - 1); ...; a_1; a_0]. The regression 
...
% coefficients of a polynomial which is the integral of the regression 
