...
% 'yFitSpline' of the estimated values of f('xFitSpline'), where 
% 'xFitSpline' is the input vector of values of the X variable. The 
% estimation is based on the spline interpolation of the data points 
...
%% Variables
% 
% This function has the form of yFitSpline = ZFindFitSpline...
...
% 
% 'xFitSpline' is the vector of the values of the independent variable X 
% at which the value of the f function is to be estimated. The 
% 'xFitSpline' vector must be a column vector of real numbers. 
% 
...
DrawZFitSplineInput = {xData, yData, min(xFitSpline(1), xData(1)), ...
