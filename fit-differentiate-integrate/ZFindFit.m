...
% arbitrary function Y = f(X), this function returns the vector 'yFit' of 
% the estimated values of f('xFit'), where 'xFit' is the input vector of 
...
%    (2) plot the estimated curve of the f function along with the data 
...
% 
% 'xFit' is the vector of the values of the independent variable X at 
% which the value of the f function is to be estimated. The 'xFit' vector 
