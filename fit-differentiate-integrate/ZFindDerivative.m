function [yDerivative, varargout] = ZFindDerivative...
...
% 'yDerivative' of the estimated values of f^('OrdDeriv')('xDerivative'), 
% where f^('OrdDeriv') is the 'OrdDeriv'-th order derivative of the f 
% function and 'xDerivative' is the input vector of values of the X 
% variable. 
% By setting the optional parameters, the user can: 
%    (1) set the order of differentiation, the default value of which is 
%        'OrdDeriv' = 1, 
%    (2) choose from various methods of the estimation, some of which 
%        offer additional optional parameters and output variables or need 
%        additional required parameters, 
%    (3) plot the estimated curve of the f function along with the data 
...
% 
% 'xDerivative' is the vector of the values of the independent variable X 
% at which the value of the derivative of the f function is to be 
% estimated. The 'xDerivative' vector must be a column vector of real 
% numbers. 
% 
% 'varargin' represents the additional input parameters. The basic 
% optional parameters are named ''OrdDeriv'', ''Type'', and ''Figure''. 
%    -''OrdDeriv'' is the name of the parameter the value of which is the 
%     derivative order 'OrdDeriv'. The default value is 1. 
%    -''Type'' is the name of the parameter the value of which determines 
%     the mathematical method with which the f function is estimated. The 
%     value of the 'Type' parameter can either be ''A'', ''Spline'', or 
%     ''PolyFit''. The default value is ''A''. The value of the ''Type'' 
%     parameter determines the set of the optional output parameters and 
%     additional required or optional input parameters. 
...
% 
% 'varargout' represents the optional output parameters. The set of the 
% optional parameters depends on the value of the 'Type' optional input 
% parameter. 
